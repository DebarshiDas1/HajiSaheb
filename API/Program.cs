...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "HajiSaheb", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<HajiSahebContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "HajiSaheb API v1");
