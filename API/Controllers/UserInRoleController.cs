...
namespace HajiSaheb.Controllers
{
    ...
    public class UserInRoleController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [Produces("application/json")]
        public IActionResult UpdateById(Id id, [FromBody] UserInRole updatedEntity)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [Produces("application/json")]
        public IActionResult UpdateById(Id id, [FromBody] JsonPatchDocument<UserInRole> updatedEntity)
        {
