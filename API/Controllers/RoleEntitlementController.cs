...
namespace HajiSaheb.Controllers
{
    ...
    public class RoleEntitlementController : ControllerBase
    {
        ...
        public RoleEntitlementController(HajiSahebContext context)
        {
            _context = context;
        }
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [Produces("application/json")]
        public IActionResult UpdateById(Id id, [FromBody] RoleEntitlement updatedEntity)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [Produces("application/json")]
        public IActionResult UpdateById(Id id, [FromBody] JsonPatchDocument<RoleEntitlement> updatedEntity)
        {
